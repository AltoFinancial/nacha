defmodule Nacha.FileTest do
  ...
  @sample_file_string Enum.join(
                        [
                          ...
                          "5200Sell Co                             1234567890CCD          170101170101   1123456780000001",
                          ...
                          "5200Sell Co                             1234567890PPD          170101170101   1123456780000002",
    ...
    sample_file_string_with_offset =
      Enum.join(
        [
          ...
          "5200My Bank Name                        222211113 PPD          170101170101   1231380100000001",
